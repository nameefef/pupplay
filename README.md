...
- **5 speed settings, 1–10 critters** on screen at once, and **10 size levels measured against your screen** (7%–40% of screen height) rather than a fixed multiplier, so a given step looks the same on any phone. Step 5 is the sweet spot for the device and is the default; critters shrink slightly when many are on screen at once
