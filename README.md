...
- **5 speed settings, 1–10 critters** on screen at once, and **10 size levels derived from your screen**, bounded below by what a dog can actually resolve (18mm, from canine acuity at a typical viewing distance) and above by what leaves room to run (45% of the screen's short edge). A phone gets 18–32mm, a tablet 18–63mm
